...
describe("SessionManager", () => {
  ...
  describe("createSession", () => {
    ...
    it("should throw error when creation fails", async () => {
      ...
      await expect(
        sessionManager.createSession("test-user", mockConfig),
  ...
  describe("getSession", () => {
    ...
    it("should throw error when retrieval fails", async () => {
      ...
      await expect(
        sessionManager.getSession("test-session-id"),
  ...
  describe("pauseSession", () => {
    ...
    it("should throw error when pause fails", async () => {
      ...
      await expect(
        sessionManager.pauseSession("test-session-id"),
  ...
  describe("verifySessionIntegrity", () => {
    it("should verify session integrity successfully", async () => {
      ...
      const result =
        await sessionManager.verifySessionIntegrity("test-session-id");
  ...
  describe("utility methods", () => {
    ...
    it("should get status display text", () => {
      expect(sessionManager.getStatusDisplay(SessionStatus.Active)).toBe(
        "Recording",
      );
      expect(sessionManager.getStatusDisplay(SessionStatus.Paused)).toBe(
        "Paused",
      );
      expect(sessionManager.getStatusDisplay(SessionStatus.Completed)).toBe(
        "Completed",
      );
      expect(sessionManager.getStatusDisplay(SessionStatus.Failed)).toBe(
        "Failed",
      );
    });
    ...
    it("should get status colors", () => {
      ...
      expect(sessionManager.getStatusColor(SessionStatus.Paused)).toBe(
        "yellow",
      );
      expect(sessionManager.getStatusColor(SessionStatus.Completed)).toBe(
        "blue",
      );
