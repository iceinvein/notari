...
describe("VerificationResults", () => {
  ...
  it("shows verification input field", () => {
    ...
    expect(screen.getByPlaceholderText("Enter proof pack URL or upload file...")).toBeInTheDocument();
  ...
  it("enables verify button when URL is entered", () => {
    ...
    const input = screen.getByPlaceholderText("Enter proof pack URL or upload file...");
    fireEvent.change(input, { target: { value: "https://example.com/proof-pack" } });
