...
describe('WindowPicker', () => {
  ...
  describe('window list', () => {
    it('should show empty state when no windows available', () => {
      ...
      expect(screen.getByText('Make sure you have applications open and try refreshing')).toBeInTheDocument();
    });
  ...
  describe('filtering', () => {
    ...
    it('should show no allowed windows message when all windows are filtered', () => {
      ...
      expect(screen.getByText(/1 window available, but none match your allowed applications/)).toBeInTheDocument();
    });
  });
