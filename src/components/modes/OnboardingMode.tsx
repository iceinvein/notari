        ...
        <div className="space-y-4">
          <div className="space-y-3">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-sm font-medium text-white">Secure Capture</h4>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-sm font-medium text-white">Blockchain Proof</h4>
                <p className="text-xs text-gray-400">Immutable verification on the blockchain</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex space-x-3">
            ...
            <Button
              color="primary"
              size="lg"
              className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium transition-all duration-200"
              onPress={handleNext}
            >
