...
export function ProofPackExport({
  proofPack,
  onComplete,
}: ProofPackExportProps) {
        ...
        <CardBody className="text-center py-12">
          <div className="text-gray-500 dark:text-gray-400">
            <svg
              ...
              viewBox="0 0 24 24"
              role="img"
              aria-label="No proof pack generated"
            >
              <path
                strokeLinecap="round"
      ...
      <Card className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
        <CardBody className="text-center py-12">
          ...
          <p className="text-green-700 dark:text-green-200 mb-6">
            Your proof pack has been successfully generated and anchored on the
            blockchain.
          </p>
          ...
          <div className="space-y-4 max-w-md mx-auto">
              ...
              <Button
                ...
                onPress={() => {
                  ...
                  navigator.clipboard.writeText(
                    "https://verify.notari.com/proof-pack-123",
                  );
                }}
              >
            ...
            <Button variant="flat" onPress={onComplete} className="w-full">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                ...
                <div className="text-sm">
                  {formatDate(proofPack.metadata.created)}
                </div>
              </div>
            </div>
          </div>
        ...
        <Card>
          <CardBody>
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-2">
                <Button variant="flat" onPress={simulateExport}>
                  Export Only
                </Button>
                <Button color="primary" onPress={handleExportAndAnchor}>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 dark:text-blue-200 mt-1">
                Anchoring to blockchain creates an immutable timestamp and proof
                of existence. This enables independent verification without
                requiring access to your original data.
              </p>
            </div>
          </div>
        </CardBody>
